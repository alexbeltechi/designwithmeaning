...
export function ConfirmationDrawer({
  ...
  const content = (
    <div className="space-y-4 py-4" data-section="confirmation-content">
      {/* Swap Summary */}
      <div className="space-y-3 bg-zinc-950 p-4 rounded-lg border border-zinc-800" data-section="swap-summary">
        ...
        <div className="flex items-center justify-between text-sm">
          <span className="text-zinc-400">Value after gas</span>
      ...
      <Separator className="bg-zinc-800" data-component="shadcn-separator" />
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex flex-wrap gap-1.5 justify-end">
              {route.badges.map((badge) => (
                <Badge key={badge} variant="secondary" className="text-xs bg-zinc-800 text-zinc-300" data-component="shadcn-badge" data-variant="secondary">
                  {badge.replace('_', ' ')}
                </Badge>
              ))}
            </div>
  ...
  const footer = (
    <>
      ...
      <p className="text-xs text-left text-zinc-500 w-full mt-2">
  ...
  if (isMobile) {
    return (
      <Sheet open={open} onOpenChange={onOpenChange} data-component="shadcn-sheet">
        <SheetContent side="bottom" className="h-auto max-h-[90vh] overflow-y-auto bg-zinc-950 border-zinc-800" data-component="shadcn-sheet-content">
          <SheetHeader data-component="shadcn-sheet-header">
            ...
            <SheetDescription className="text-zinc-400" data-component="shadcn-sheet-description">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} data-component="shadcn-dialog">
      <DialogContent className="max-w-md bg-zinc-950 border-zinc-800" data-component="shadcn-dialog-content">
        <DialogHeader data-component="shadcn-dialog-header">
          ...
          <DialogDescription className="text-zinc-400" data-component="shadcn-dialog-description">
            Review your swap details before confirming
          </DialogDescription>
        </DialogHeader>
        {content}
