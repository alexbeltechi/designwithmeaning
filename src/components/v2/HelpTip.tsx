  ...
  return (
    <TooltipProvider delayDuration={100} data-component="shadcn-tooltip-provider">
      <Tooltip data-component="shadcn-tooltip">
        ...
        <TooltipContent className="max-w-xs bg-zinc-900 border-zinc-800" data-component="shadcn-tooltip-content">
...
export const HELP_CONTENT = {
  ...
  reliability: 'Based on recent execution success rates for this route. Higher numbers = more reliable.',
